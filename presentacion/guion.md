...
"Para ponernos en contexto, decidimos trabajar con un conjunto de datos sumamente famoso en la comunidad académica: el dataset de *Bank Marketing* del repositorio de la Universidad de California en Irvine. Hablamos de una base de datos con un poco más de 45.000 registros, proveniente de un banco portugués durante los años 2008 a 2010, en plena crisis financiera europea.
